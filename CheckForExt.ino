...
//  while (*(filename+x) && (*(filename+x) != '.')) x++;
  ...
  //if (strcasestr_P(filename + x, PSTR(".tap"))) {
  ...
  //else if (strcasestr_P(filename + x, PSTR(".p"))) {casduino =0; currentTask=PROCESSID; currentID=ZXP;}
  ...
  //else if (strcasestr_P(filename + x, PSTR(".o"))) {casduino =0; currentTask=PROCESSID; currentID=ZXO;}
  ...
  //else if (strcasestr_P(filename + x, PSTR(".ay"))) {casduino =0; currentTask=GETAYHEADER; currentID=AYO; AYPASS = 0; hdrptr = HDRSTART;}
  ...
  //else if (strcasestr_P(filename + x, PSTR(".uef"))) {casduino =0; currentTask=GETUEFHEADER; currentID=UEF;}
  ...
  //else if (strcasestr_P(filename + x, PSTR(".cas"))) {
