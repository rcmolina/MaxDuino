...
#if defined(Use_CAS) && defined(Use_DRAGON) && defined(Use_Dragon_sLeader) && not defined(bothSL_in_FH)
...
#if defined(Use_CAS) && defined(Use_DRAGON) && defined(Use_Dragon_sLeader) && defined(bothSL_in_FH)
