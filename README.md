...
11/06/2022: SdFat improvements. ZX:inject the real filename into the fake ay header
Removed initial pause from zx81 loading to avoid inversion problems + Refixed inversion for zx loading.
