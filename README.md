...
* V1.57 Changed zx81 TSXControl to Speed to avoid polarity problems. Better zx81 file loading. Removed Amstrad tweaking to slower ID15, so Oricium game now can load in 4 minutes in Oric Atmos (attached to test).
